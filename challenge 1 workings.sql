...
SELECT 
	SUM(cost_$) AS total_car_sales
FROM car_showroom
WHERE YEAR(purchase_date) = 2022;

-- 2. What is the total number of cars sold by each salesperson?
SELECT 
	DISTINCT(name) AS salesperson_name, 
	COUNT(make) AS no_of_sales
FROM car_showroom
...
SELECT 
	style, 
    SUM(cost_$) AS total_revenue2022
FROM car_showroom
WHERE 
